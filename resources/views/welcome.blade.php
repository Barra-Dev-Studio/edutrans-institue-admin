                        ...
                        <div class="card-body h-full">
                            <div class="flex flex-col items-center justify-center gap-4 h-full">
                                ...
                                <div class="col-span-2 text-center flex flex-col justify-between">
                                    ...
                                    <p class="font-bold">Mr. Slamet Khoirul<br>Koordinator Bintek DPRD</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body h-full">
                            <div class="flex flex-col items-center justify-center gap-4 h-full">
                                ...
                                <div class="col-span-2 text-center flex flex-col justify-between">
                                    ...
                                    <p class="font-bold">Ms. Airin Wenas<br>Unika Soegijapranata</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body h-full">
                            <div class="flex flex-col items-center justify-center h-full gap-4">
                                ...
                                <div class="col-span-2 text-center h-full flex flex-col justify-between">
                                    ...
                                    <p class="font-bold">Mr. Oscar Carascalao<br>SMA Pradita Dirgantara</p>
                                </div>
                            </div>
                        </div>
                    </div>
