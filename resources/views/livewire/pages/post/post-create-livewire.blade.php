<div>
    <form wire:submit.prevent="submit" class="prose">
        ...
        <div class="mt-4">
            ...
            <x-select-input :options="$statuses" :value="'id'" :label="'name'" name="status" wire:model.live="status"></x-select-input>
        ...
        <div class="mt-4">
            ...
            <x-textarea-input wire:model.live="description" id="description" class="block mt-1 w-full" type="text" name="description"
