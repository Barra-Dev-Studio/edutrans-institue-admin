    ...
    <form wire:submit.prevent="submit" class="prose">
        ...
        <div class="mt-4">
            <div>
                ...
                <x-select-input :options="$categories" :value="'id'" :label="'name'" name="category" wire:model.live="category"
                    wire:change="setSelectedCategory"></x-select-input>
        ...
        <div class="grid grid-cols-2 mt-4 gap-2">
            ...
            <div>
                ...
                <x-text-input wire:model.live="publishedYear" id="publishedYear" class="block mt-1 w-full"
                    type="month" name="publishedYear" placeholder="Published year" required />
        ...
        <div class="grid grid-cols-2 mt-4 gap-2">
            ...
            <div>
                ...
                <x-text-input wire:model.live="discountPrice" id="discountPrice" class="block mt-1 w-full"
                    type="number" name="discountPrice" placeholder="Discount price" required />
        ...
        <div class="grid grid-cols-4 mt-4 gap-2">
            <div>
                ...
                <x-text-input wire:model.live="totalPages" id="totalPages" class="block mt-1 w-full" type="number"
                    name="totalPages" placeholder="Total pages" required />
            ...
            <div>
                ...
                <x-text-input wire:model.live="totalPurchased" id="totalPurchased" class="block mt-1 w-full" type="number"
                    name="totalPurchased" placeholder="Total purchased" required />
        ...
        <div class="mt-4">
            <div class="grid grid-cols-2 gap-4">
                <div class="@if($status === 'DRAFT') bg-emerald-100 @else bg-slate-100 @endif p-4 border border-slate-300 cursor-pointer"
                    ...
                    <h5 class="text-slate-700 mb-0">Draft @if($status === 'DRAFT') <span><i class="bx bx-badge-check"></i></span>@endif
                    </h5>
