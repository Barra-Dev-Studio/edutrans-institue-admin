                ...
                <tr class="border-b border-gray-50 dark:border-zinc-600 dark:bg-zinc-700/50 dark:text-zinc-100 bg-white prose" wire:key="{{ $user->id }}">
                  ...
                  <td class="p-3 flex">
                    <a href="{{ route('dashboard.user.show', $user->id) }}"
                        class="p-2 flex items-center bg-sky-400 hover:bg-sky-300 text-lg rounded-tl rounded-bl !no-underline">
                    ...
                    <button wire:click="showModal('dashboard.user.destroy', '{{ $user->id }}')"
