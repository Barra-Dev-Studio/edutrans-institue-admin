    ...
    <div class="bg-slate-50 p-10 rounded-lg border border-slate-300/40 md:min-w-[460px] md:max-w-[460px]">
        ...
        <form wire:submit="login">
            ...
            <div>
                ...
                <x-text-input wire:model="email" id="email" class="block mt-1 w-full" type="email" name="email" required autofocus autocomplete="username" placeholder="Email" />
