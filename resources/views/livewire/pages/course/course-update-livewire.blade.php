<div class="grid grid-cols-3 gap-4">
    <div class="card dark:border-zinc-600 dark:bg-zinc-800 bg-slate-50 w-full">
        <div class="card-body pb-4 border-b border-slate-200">
            <h5 class="dark:text-zinc-100">Update course</h5>
        </div>
        <div class="card-body">
            <div class="w-full">
                <ul class="mb-4">
                ...
                <button wire:loading.attr="disabled" wire:target="submit" class="bg-emerald-500 px-6 py-3 rounded text-white hover:bg-emerald-600 block w-full" form="update-course-form" type="submit"><span wire:loading.remove wire:target="submit">Save course</span><span wire:loading wire:target="submit"><x-spinner></x-spinner></span></button>
            </div>
        </div>
    </div>
    <form wire:submit.prevent="submit" class="col-span-2" id="update-course-form">
