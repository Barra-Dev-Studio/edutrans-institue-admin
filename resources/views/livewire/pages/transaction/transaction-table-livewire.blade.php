                ...
                <table class="table table-striped w-full text-left border border-gray-50 dark:border-zinc-600">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-50 dark:border-zinc-600 dark:bg-zinc-700/50 dark:text-zinc-100 bg-white prose"
                            ...
                            <td class="p-3">{{ $transaction->member->name }}</td>
                            <td class="p-3">
                            ...
                            <td class="p-3 flex">
                                <a href="{{ route('dashboard.transaction.show', $transaction->id) }}"
                        ...
                        <tr
                            ...
                            <td class="p-3 text-center" colspan="9">We can't find what you are looking for</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
