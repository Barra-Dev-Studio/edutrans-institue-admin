<x-app-layout>
    ...
    <div class="flex justify-end items-center mb-4">
        <a href="{{ route('dashboard.categorypost.create') }}"
            class="bg-emerald-500 px-6 py-3 rounded text-white hover:bg-emerald-600 prose !no-underline">Create new category</a>
    </div>
