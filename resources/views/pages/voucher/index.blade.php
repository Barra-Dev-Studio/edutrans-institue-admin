<x-app-layout>
    ...
    <div class="flex justify-end items-center mb-4">
        <a href="{{ route('dashboard.voucher.create') }}"
            class="bg-emerald-500 px-6 py-3 rounded text-white hover:bg-emerald-600 prose !no-underline text-sm">Create new voucher</a>
    </div>
    ...
    <div class="card dark:border-zinc-600 dark:bg-zinc-800 bg-slate-50">
        ...
        <div class="card-body">
            <livewire:pages.voucher.voucher-table-livewire></livewire:pages.voucher.voucher-table-livewire>
        </div>
    </div>
</x-app-layout>
