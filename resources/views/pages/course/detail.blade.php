<x-guest-layout title="{{ $course->title }} | Edutrans Institute">
    ...
    <livewire:pages.course.course-detail-livewire :$course :$previews :$chapters :$sections :$ratings></livewire:pages.course.course-detail-livewire>
</x-guest-layout>
