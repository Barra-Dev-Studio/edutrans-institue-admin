        ...
        <div id="sidebar-menu">
            <ul class="metismenu" id="side-menu">
                ...
                @can("access-member")
                    ...
                    <li>
                        <a href="{{ route('member.certificate') }}" class="pl-6 pr-4 py-3 block text-sm font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">
                            <i data-feather="award"></i>
                            <span data-key="t-certificate" class="prose"> Certificate</span>
                        </a>
                    </li>
                    <li>
